...
@section('content')
<style>
    .form-section-title { font-size: 0.9rem; font-weight: 700; color: #4e73df; letter-spacing: 1px; margin-bottom: 20px; display: block; border-left: 4px solid #4e73df; padding-left: 10px; }
    .input-group-custom { background: #f8f9fa; border: 2px solid #f1f3f5; border-radius: 12px; transition: 0.3s; }
    .input-group-custom:focus-within { border-color: #4e73df; background: #fff; box-shadow: 0 0 0 4px rgba(78, 115, 223, 0.1); }
    .input-group-custom input, .input-group-custom select, .input-group-custom textarea { border: none; background: transparent; padding: 12px; width: 100%; outline: none; }
</style>
                ...
                <div class="row">
                        ...
                        <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group-custom">
                                    <input type="text" name="nama_barang" placeholder="Contoh: Laptop MacBook Pro" required>
                                </div>
                            </div>
                    ...
                    <div class="col-md-5">
                        <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                            ...
                            <div class="mb-3">
                                <label class="small fw-bold mb-2">JENJANG / UNIT</label>
                                <div class="input-group-custom">
                                    <select name="jenjang_id" required>
                                        <option value="">Pilih Unit...</option>
                                        @foreach($jenjangs as $j) <option value="{{ $j->id }}">{{ $j->nama_jenjang }}</option> @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group-custom">
                                    <select name="kategori_id" required>
                                        ...
                                        @foreach($kategoris as $k) <option value="{{ $k->id }}">{{ $k->kode_kategori }} - {{ $k->nama_kategori }}</option> @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group-custom">
                                    <select name="gedung_id" required>
                                        ...
                                        @foreach($gedungs as $g) <option value="{{ $g->id }}">{{ $g->nama_gedung }}</option> @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="input-group-custom">
                                    <input type="text" name="ruang" placeholder="Ruang IT...">
                                </div>
                            </div>
                            ...
                            <div class="mb-0">
                                ...
                                <div class="input-group-custom">
                                    <select name="sumber_dana_id" required>
                                        ...
                                        @foreach($sumberDanas as $s) <option value="{{ $s->id }}">{{ $s->nama_sumber }}</option> @endforeach
                                    </select>
                                </div>
                            </div>
                        </div>
